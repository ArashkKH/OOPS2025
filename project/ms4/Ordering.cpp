...
namespace seneca {
    ...
    void Ordering::printTotals(ostream& ostr, double total) const {
        ...
        ostr << setfill(' ') << right;
        ostr << setw(27) << "Total:" << setw(11) << fixed << setprecision(2) << total << endl;
        ostr << setw(27) << "Tax:" << setw(11) << fixed << setprecision(2) << tax << endl;
        ostr << setw(27) << "Total+Tax:" << setw(11) << fixed << setprecision(2) << grandTotal << endl;
        ostr << "========================================" << endl;
    }
