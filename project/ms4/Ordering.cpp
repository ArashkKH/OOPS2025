...
namespace seneca {
    ...
    void Ordering::printTotals(ostream& ostr, double total) const {
        ...
        ostr << setfill(' ') << right;
        ostr << setw(31 - 4) << "Total:" << setw(9 + 4) << fixed << setprecision(5) << total << endl;
        ostr << setw(31 - 4) << "Tax:" << setw(9 + 4) << fixed << setprecision(5) << tax << endl;
        ostr << setw(31 - 4) << "Total+Tax:" << setw(9 + 4) << fixed << setprecision(5) << grandTotal << endl;
        ostr << "========================================" << endl;
